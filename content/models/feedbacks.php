...
function feedback_add()
{
    ...
    if (!preg_match("/([a-z0-9_]+|[a-z0-9_]+\.[a-z0-9_]+)@(([a-z0-9]|[a-z0-9]+\.[a-z0-9]+)+\.([a-z]{2,4}))/i", $email)) {
        echo "<div style='padding-top: 200px' class='container'><div class='alert alert-danger' style='text-align: center;'><strong>NO!</strong> This email is not valid. Please enter another email. <br><br><a href='javascript: history.go(-1)'>Go back</a></div></div>";
        require('content/views/feedback/result.php');
        exit;
    } elseif (!preg_replace("[^0-9]", '', $phone)) {
        echo "<div style='padding-top: 200px' class='container'><div class='alert alert-danger' style='text-align: center;'><strong>NO!</strong> This phone number is not valid. Please enter another phone number. <br><br><a href='javascript: history.go(-1)'>Go back</a></div></div>";
        require('content/views/feedback/result.php');
        exit;
    }
