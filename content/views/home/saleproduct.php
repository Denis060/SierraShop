	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-12">
						<h2><a href="type/3-san-pham-dang-giam-gia">Products On <strong>Sale</strong></a></h2>
					</div>
							...
							<li class="col-sm-3 col-xs-12 product">
								...
								<span class="product-thumb-info">
									<form style="text-align: center;" action="cart/add/<?= $saleoffProduct['id']; ?>" method="post">
										...
										<a class="add-to-cart-product"><button type="submit" href="cart/add/<?= $saleoffProduct['id']; ?>"><i class="fa fa-shopping-cart"></i> Add to Cart</button></a>
									</form>
