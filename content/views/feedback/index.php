        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (isset($userNav)) {
                    ...
                    echo '<p>Already have a user account? <a href="admin.php">Click here to log in.</a></p>';
                } ?>
            </div>
        </div>
        <div class="row">
                        ...
                        <div id="collapseTwo" class="accordion-body collapse in">
                            <div class="panel-body">
                                <form action="index.php?controller=feedback" role="form" id="" method="post">
                                    ...
                                    <?php else : ?>
                                        <h3>You will send feedback as user: <a href="admin.php?controller=user&action=info&user_id=<?= $userNav ?>"><b><?= $userAction['user_name'] ?></b></a></h3>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <label><strong>Message - Feedback details: </strong></label>
                                                <textarea name="message" id="message" class="form-control" cols="30" rows="10" placeholder="Please enter your feedback information in this box..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group" style="text-align: center">
                                        <button type="submit" class="btn btn-primary"><i class="fa  fa-check-square-o"></i> Confirm send feedback</button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <div class="col-md-3">
                <?php if ($product <> 0) : ?>
                    <h3>The product you selected to give feedback</h3>
                    <div class="row">
