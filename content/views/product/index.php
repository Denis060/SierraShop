            ...
            <div class="col-md-9">
                    ...
                    <div class="col-md-6">
                        <div class="summary entry-summary">
                            ...
                            <form enctype="multipart/form-data" method="post" class="cart"
                                ...
                                <div class="quantity">
                                    <input type="number" class="input-text qty text" title="Enter to Change Quantity"
                ...
                <button class="btn btn-primary btn-icon" role="button" type="submit"><i
                    class="fa fa-shopping-cart"></i> Add to cart</button>
                            ...
                            <hr class="tall">
                            <div class="feedback">
                                <a href="index.php?controller=feedback&action=index&product_id=<?= $product['id'] ?>"><b>Click here</b></a> to send feedback about this product.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="tabs tabs-product">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#productReviews" data-toggle="tab">Comments (<?= $comments_total ?>)</a></li>
                            </ul>
                                            ...
                                            <form action="index.php?controller=comment" id="submitReview" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <?php if (isset($userNav)) : ?>
                                                                <label>You are logged in as <strong><?= $userLogin['user_name'] ?></strong>. Do you want to <a href="admin.php?controller=home&action=logout">logout</a>?</label>
                                                            <?php else : ?>
                                                                <label>Do you want to <strong><a href="admin.php?controller=home&action=login">login</a></strong> to comment with your account?</label>
                                                            <?php endif; ?>
                                                            <textarea maxlength="5000" data-msg-required="Please enter your message." rows="10" class="form-control" name="content" id="message" placeholder="Enter your review, message, or comment about the product ..."></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2>Products <strong>Related to Category</strong></h2>
                    </div>
                    ...
                    <ul class="products product-thumb-info-list">
                        ...
                        <h3 class="col-sm-12">No related products found.</h3>
                        <?php endif; ?>
