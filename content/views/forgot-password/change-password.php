                ...
                <div class="col-lg-4 col-sm-12">
                    <form method="POST" class="card auth_form" action="index.php?controller=forgot-password&action=result-change-password">
                        <div class="header">
                            ...
                            <span>Set a new password <i class="zmdi zmdi-favorite"></i></span>
                        </div>
                        ...
                        <div class="body">
                            ...
                            <div class="signin_with mt-3">
                                <a class="link" href="admin.php">Remembered your password? Go to "Login"!</a>
                            </div>
                        </div>
                    </form>
                    <div class="copyright text-center">
                        ...
                        <span>Developed by <a href="https://tanhongit.com" target="_blank">TanHongIT</a></span>
                    </div>
                </div>
