...
<footer class="short" id="footer">
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                <h4>Information</h4>
                <p><?= $aboutFooter ?><a href="<?= $aboutUrl ?>" class="btn-flat btn-xs">Read more <i class="fa fa-arrow-right"></i></a></p>
                <hr class="light">
                <div class="row">
                    <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <p class="short">Secondary Phone: <?= $phone2 ?></p>
        ...
        <div class="container">
            <div class="row">
                <p>© Copyright <script>
                    ...
                    </script> - Developed by <span><a href="https://ibrahimfofanah.com">SmartWave Media</a></span>.</p>
            </div>
        </div>
    </div>
</footer>
