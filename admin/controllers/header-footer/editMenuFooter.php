...
if (mysqli_num_rows(mysqli_query($linkConnectDB, "SELECT id FROM menu_footers WHERE id='$menuFooterId'")) == 0) {
    echo "<div style='padding-top: 200px' class='container'><div class='alert alert-danger' style='text-align: center;'><strong>NO!</strong> This field does not exist. <a href='javascript: history.go(-1)'>Go back</a></div></div>";
    require('admin/views/header-footer/result.php');
    exit;
}

$title = 'Edit website footer menu link';
