                    ...
                    <div class="col-xs-12">
                        ...
                        <?php if ($order['status'] == 0) { ?>
                            <form id="order_form" method="post" action="admin.php?controller=order&amp;action=inprocess" role="form">
                                <div style="text-align: center;" class="form-group">
                                    ...
                                    <button class="btn btn-primary waves-effect" type="submit">Process Order</button>
                                    <a href="admin.php?controller=order" class="btn btn-warning waves-effect">Back</a>
                                </div>
                            </form>
                        <?php } elseif ($order['status'] == 2) { ?>
                            <form id="order_form" method="post" action="admin.php?controller=order&amp;action=complete" role="form">
                                <div style="text-align: center;" class="form-group">
                                    <input name="order_id" type="hidden" value="<?= $order['id']; ?>" />
                                    <button class="btn btn-primary waves-effect" type="submit">Confirm Order Successfully Processed</button>
                                    <a href="admin.php?controller=order" class="btn btn-warning waves-effect">Back</a>
                                </div>
                            </form>
                        <?php } else { ?>
