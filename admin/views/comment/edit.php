    ...
    <div class="body_scroll">
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Edit Comment Information</h2>
                    <ul class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <h2 style="font-weight: bold;">Edit Section</h2>
                <div class="col-lg-12">
                    Link:
                    ...
                    <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=comment&action=edit" enctype="multipart/form-data" role="form">
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="name" type="text" value="<?= $comment ? $comment['author'] : ''; ?>" class="form-control" id="name" placeholder="your real full name..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input name="email" type="email" maxlength="100" value="<?= $comment ? $comment['email'] : ''; ?>" class="form-control" id="color" placeholder="Enter your email..." required="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea name="subject" type="text" class="form-control" id="ckeditor" required placeholder="Feedback content..."><?= $comment ? $comment['content'] : ''; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <h4>Status:</h4>
                        ...
                        <div class="form-group" style="text-align: center;">
                            <button class="btn btn-primary waves-effect" type="submit">Update Comment Information</button>
                            <a class="btn btn-warning waves-effect" href="admin.php?controller=comment">Go Back</a>
                        </div>
                    </form>
                </div>
            </div>
