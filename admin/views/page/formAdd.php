            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?= 'Warning: </strong> You are on the add new page screen, please be careful!!! <a target="_blank" href="#"> View documentation</a>'; ?>
                    ...
                    $get_user_by = getRecord('users', $userNav) ?>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="totalview" type="text" value="<?= $post ? $post['totalView'] : 0; ?>" class="form-control" id="totalview" placeholder="Views..." />
                                                </div>
                                            </div>
                                        </div>
