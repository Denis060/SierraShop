                    ...
                    <div class="card project_list">
                        <div class="table-responsive">
                            <table class="table table-hover c_table theme-color">
                                ...
                                <tbody>
                                    <?php if (empty($pages)) {
                                        echo '<h3><strong>There are currently no pages in the system.</strong></h3>';
                                    }
                                    foreach ($pages as $page) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a onclick="return confirm('Are you sure to delete?')" title="Delete" class="btn btn-danger btn-round" href="admin.php?controller=page&action=delete&page_id=<?= $page['id'] ?>"> <i class="zmdi zmdi-delete"></i> Delete Permanently</a>
                                                <a title="Restore" class="btn btn-success btn-round" href="admin.php?controller=page&action=restore&post_id=<?= $page['id'] ?>"> <i class="zmdi zmdi-refresh-sync"></i> Restore</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
