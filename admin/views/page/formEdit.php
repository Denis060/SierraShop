            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?= $post ? 'Warning: </strong> You are editing the page "' . $post['post_title'] . '", please be careful!!! <a target="_blank" href="#"> View documentation</a>' : 'Warning: </strong> You are creating a new page, please be careful!!! <a target="_blank" href="#"> View documentation</a>'; ?>
                    ...
                    $get_user_by = getRecord('users', $userNav) ?>
                                        ...
                                        <h2 class="card-inside-title" style="font-weight:bold;">Slug (Page URL):</h2>
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="slug" type="text" value="<?= $post ? $post['post_slug'] : ''; ?>" class="form-control" id="slug" placeholder="Enter page URL..." required="" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <?php if (isset($post)) : ?>
                                            <div class="row clearfix">
                                                <div>
                                                    <div>
                                                        <h4 style="text-align: center;">Current Thumbnail</h4>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="totalview" type="text" value="<?= $post ? $post['totalView'] : ''; ?>" class="form-control" id="totalview" placeholder="Views..." />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <button class="btn btn-primary waves-effect" type="submit"><?= $post ? 'Update Page' : 'Add New Page'; ?></button>
