        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Date Retrieval</strong> "All products in the order" </h2>
    ...
    ?>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="admin.php?controller=feedback&action=add&order_id=<?= $order['id'] ?>" method="post">
                            ...
                            <h4>Enter your feedback for this order</h4>
                            <textarea name="message" placeholder="Enter your feedback" required style="width: 100%;" rows="10"></textarea>
