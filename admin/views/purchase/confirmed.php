        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    <h2>Purchase</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="admin.php"><i class="zmdi zmdi-home"></i>SaloneChart</a></li>
                                ...
                                <ul class="comment-reply list-unstyled">
                                    <?php foreach ($orderDetail as $product) : ?>
                                        <li>
                                            ...
                                            <div class="text-box">
                                                <h5><a style="color: #000;" href="product/<?= $product['product_id']; ?>-<?= $product['slug']; ?>"><?= number_format($product['product_price'], 0, ',', '.') ?>đ</a></a><span style="float: right;"><?= $status[$order['status']] ?></span></h5>
                                        ...
                                        <hr>
                                    <?php endforeach; ?>
                                    <span style="font-size: 1.2em; float: right; padding-left: 20px;"><b><a style="color: #fff" title="Total" class="btn btn-primary btn-round"><i class="zmdi zmdi-money"></i> Total: <?= number_format($order['cart_total'], 0, ',', '.') ?>đ</a></b></span>
                                    <span>
