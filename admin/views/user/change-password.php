            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong>You are changing your password, please be careful! <a target="_blank" href="#"> View the documentation</a>
                        ...
                        <div class="body">
                            <form id="product-form" class="form-horizontal" method="post" action="admin.php?controller=user&action=result" enctype="multipart/form-data" role="form">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="currentPassword" type="password" maxlength="50" value="" class="form-control" placeholder="e.g. currentpassword" required="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="newPassword" type="password" value="" maxlength="50" class="form-control" placeholder="Enter new password..." required="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="confirmPassword" type="password" value="" maxlength="50" class="form-control" placeholder="Confirm new password..." required="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" style="text-align: center;">
                                    <button class="btn btn-primary waves-effect" type="submit">Confirm Change of New Password</button>
