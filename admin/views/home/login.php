...
<head>
    ...
    <!-- Custom Css -->
    <link rel="stylesheet" href="<?= PATH_URL ?>admin/themes/plugins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= PATH_URL ?>admin/themes/css/style.min.css">
</head>
...
<body class="theme-blush">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <form class="card auth_form" action="admin.php?controller=home&action=login" role="form" method="post">
                        <div class="header">
                            <img class="logo" src="<?= PATH_URL ?>admin/themes/images/logo.svg" alt="">
                            <h5>Log in</h5>
                        </div>
                        <div class="body">
                    ...
                    <div class="copyright text-center">
                        ...
                        <span>Design: <a href="https://ibrahimfofanah.com/" target="_blank">SmartWave Media</a></span><span> - Developed by <a href="https://ibrahimfofanah.com" target="_blank">Ibrahim Denis Fofanah</a></span>
                    </div>
                </div>
                <div class="col-lg-8 col-sm-12">
                    <div class="card">
                        <img src="<?= PATH_URL ?>admin/themes/images/signin.svg" alt="Sign In" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Jquery Core Js -->
    <script src="<?= PATH_URL ?>admin/themes/bundles/libscripts.bundle.js"></script>
    <script src="<?= PATH_URL ?>admin/themes/bundles/vendorscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js -->
</body>
