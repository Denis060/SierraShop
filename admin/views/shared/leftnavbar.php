<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="index.php"><img src="admin/themes/images/logo.svg" width="25" alt="Aero"><span class="m-l-10">SierraShop</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
            ...
            <li <?= $yourPurchaseNav ?? '' ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-assignment"></i><span>Your Purchase</span></a>
                <ul class="ml-menu">
                    ...
                    <li><a href="admin.php?controller=purchase&action=confirmed">Confirmed Orders</a></li>
                    <li><a href="admin.php?controller=purchase&action=delivery">Orders in Delivery</a></li>
                    <li><a href="admin.php?controller=purchase&action=receied">Received Orders</a></li>
                    <li><a href="admin.php?controller=purchase&action=cancelled">Cancelled Orders</a></li>
                </ul>
            </li>
            <?php if ($userInfoNav['role_id'] != 0) :
                if ($userInfoNav['role_id'] == 1) : ?>
                    <li <?= $navCategory ?? ''; ?>> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>Category Management</span></a>
                        <ul class="ml-menu">
                            <li><a href="admin.php?controller=shop">1. Category Groups</a></li>
                            <li><a href="admin.php?controller=shop&amp;action=edit">2. Add New Category Group</a></li>
                            <li><a href="admin.php?controller=category">3. Subcategories</a></li>
                            <li><a href="admin.php?controller=category&amp;action=edit">4. Add New Subcategory</a></li>
                        </ul>
                    </li>
                    <li <?= $backupDbClass ?? '' ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-dns"></i><span>Backup</span></a>
                        <ul class="ml-menu">
                            <li><a href="admin.php?controller=backupdb">Backup Database</a></li>
                            <li><a href="admin.php?controller=backupdb&action=list">List Database Backups</a></li>
                        </ul>
                    </li>
                    <li <?= $navHF ?? '' ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-view-web"></i><span>Website View Setup</span></a>
                        <ul class="ml-menu">
                            <li><a href="admin.php?controller=slide">Homepage Slides</a></li>
                            <li><a href="admin.php?controller=header-footer">Edit Header & Footer</a></li>
                            <li><a href="admin.php?controller=header-footer&action=listMenuFooter">Footer Menu Links</a></li>
                        </ul>
                    </li>
                ...
                <li <?= $pageNav ?? '' ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-blogger"></i><span>Blog -> Page</span></a>
                    <ul class="ml-menu">
                        <li><a href="admin.php?controller=page">All Pages</a></li>
                ...
                <li <?= $productNav ?? '' ?>> <a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-collection-text"></i><span>Product Management</span></a>
                    <ul class="ml-menu">
                        <li><a href="admin.php?controller=product">Product List</a></li>
                        <li><a href="admin.php?controller=product&action=update">Recently Updated Products</a></li>
                ...
                <li <?= $orderNav ?? '' ?>><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-shopping-cart"></i><span>Order Management</span></a>
                    <ul class="ml-menu">
                        <li><a href="admin.php?controller=order">All Orders</a></li>
