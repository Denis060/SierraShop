            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="admin.php?controller=post">Posts</a></li>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?= $post ? 'Warning: </strong> You are editing the post "' . $post['post_title'] . '", please be careful!!! <a target="_blank" href="#"> View documentation</a>' : 'Warning: </strong> You are creating a new post, please be careful!!! <a target="_blank" href="#"> View documentation</a>'; ?>
                    ...
                    $get_user_by = getRecord('users', $userNav) ?>
                                        ...
                                        <h2 class="card-inside-title" style="font-weight:bold;">Post URL</h2>
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="slug" type="text" value="<?= $post ? $post['post_slug'] : ''; ?>" class="form-control" id="slug" placeholder="Enter post URL..." required="" />
                                                </div>
                                            </div>
                                        </div>
