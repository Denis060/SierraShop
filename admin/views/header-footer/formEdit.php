            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?= $contact ? 'Warning: </strong> You are editing the header-footer section for "' . $contact['contact_name'] . '". Please be careful! <a target="_blank" href="#"> View documentation</a>' : 'Warning: </strong> You are creating a new contact. Please be careful! <a target="_blank" href="#"> View documentation</a>'; ?>
                        ...
                        <div class="body">
                            <form id="contact-form" class="form-horizontal" method="post" action="admin.php?controller=header-footer" enctype="multipart/form-data" role="form">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="header">
                                            <h2 style="text-align: center;">Secondary phone</h2>
                                        </div>
                                        <div style="text-align: center;" class="body">
                                ...
                                <div class="row clearfix">
                                    <div class="card col-md-6">
                                        ...
                                        <div class="body">
                                            <input name="email" value="<?= $contact['email'] ?>" maxlength="255" type="email" class="form-control" required placeholder="Enter email...">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="header">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div style="text-align: center;" class="body">
                                            <input type="text" value="<?= $contact['zalo'] ?>" name="zalo" class="form-control" required placeholder="Enter phone...">
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
